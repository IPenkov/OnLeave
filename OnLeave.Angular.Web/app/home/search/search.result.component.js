...
var SearchResultComponent = (function () {
    ...
    //buildings: number[] = []
    function SearchResultComponent(route, router, homeService) {
        this.route = route;
        this.router = router;
    ...
    SearchResultComponent.prototype.ngOnInit = function () {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.homeService.search(this.route.params['value'])];
                    case 1:
                        data = _a.sent();
                        this.buildings = data;
                        console.log(data);
    ...
    SearchResultComponent.prototype.showSelection = function (obj, isChecked) {
        console.log(obj);
        console.log(isChecked);
    };
    SearchResultComponent.prototype.getPageCount = function () {
        var pageNumber = [];
